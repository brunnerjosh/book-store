 ...
 <%@ include file = "/partials/header.jsp" %>
    ...
    <input placeholder="RatingID" type="text" readonly="readonly" name="ratingId" value="<c:out value="${rating.ratingId}" />" /> <br />
    ...
    <input placeholder="Date of Trans" type="text" name="ratingDate"  value="<fmt:formatDate pattern="MM/dd/yyyy" value="${rating.ratingDate}" />" /> <br />
